...
For absolute clarity, LudIQ does not use any analytics or audience measurement tools, any advertising networks or trackers, any third-party crash reporting suites (such as Firebase Crashlytics), and any features of the Google Firebase ecosystem.
...
LudIQ is a general-audience application and is not specifically targeted at children. We do not knowingly collect personal data from minors. If you believe a child has inadvertently transmitted data to us via email, please contact us immediately so we can remove it.
